...
public class main {
	...
	public static void calculateWithOurDatabase()
		...
		File[] allPositivefiles = new File("TestDataSet/neutral").listFiles();
		BufferedReader inpositive = null;
		StringBuilder sbpositive = new StringBuilder();
		...
		BufferedReader oranlar = new BufferedReader(new InputStreamReader(new FileInputStream("map.txt"), "UTF-8"));
